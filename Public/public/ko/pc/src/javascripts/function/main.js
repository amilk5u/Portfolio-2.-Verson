function main() {
   ...
   function main1() {
      gsap.to(document.querySelector('.star_svg'), 1, { 'scale': 1, ease: Expo.easeInOut }, .2);
      gsap.to(document.querySelector('.circle_svg ellipse'), 1.5, { 'stroke-dashoffset': 0, ease: Expo.easeInOut });
      ...
      function callback() {
         ...
         if (i > 8) {
            ...
            document.querySelector('.deco_box').style.backgroundPosition = '0';
         }
      }
      ...
      window.addEventListener('scroll', (e) => {
         ...
         // } else if (windowWidth >= 7245 && windowWidth < 8500) {
         //    gsap.to($('.intro_img'), .4, { opacity: 0 })
         //    gsap.to($('.lg_img'), .4, { opacity: 1 })
         //    gsap.to($('.msfk_img'), .4, { opacity: 0 })
         //    gsap.to($('.hyosung_img'), .4, { opacity: 0 })
         // } else if (windowWidth >= 8500 && windowWidth < 9600) {
         //    gsap.to($('.intro_img'), .4, { opacity: 0 })
         //    gsap.to($('.msfk_img'), .4, { opacity: 1 })
         //    gsap.to($('.lg_img'), .4, { opacity: 0 })
         //    gsap.to($('.hyosung_img'), .4, { opacity: 0 })
         // } else if (windowWidth >= 9600) {
         //    gsap.to($('.intro_img'), .4, { opacity: 0 })
   ...
   if (document.querySelector('.container').classList.contains('main1')) {
      main1()
   }
